...
- When speaking Ukrainian, use the actual terms a Ukrainian fitness studio uses, not literal translations of these English names: a pass is an "абонемент" (never "пас"), a schedule is a "розклад" (never "розписання"), a training/session is a "тренування" (never "тренінг"), signing up for one is a "запис" (never "сайн-ап" or "реєстрація"), a payout is a "виплата". Stick to these consistently.
